...
## [1.2.0](https://github.com/LorcanChinnock/reflect/compare/v1.1.1...v1.2.0) (2026-07-13)


### Features

* route homeless conventions to .claude/memories/, not CLAUDE.md's body ([7119e01](https://github.com/LorcanChinnock/reflect/commit/7119e01a2af3aff79d6e5e8af0523cce0d730599))

## [1.1.1](https://github.com/LorcanChinnock/reflect/compare/v1.1.0...v1.1.1) (2026-07-12)


### Bug Fixes

* context-rot recovery now works out of the box via npx skills ([dab27c8](https://github.com/LorcanChinnock/reflect/commit/dab27c80151ad6b4ebe8b65ca817abf3670d8471))
...
- `assets/logo.svg` — a small pruning-shears mark for the README header.
